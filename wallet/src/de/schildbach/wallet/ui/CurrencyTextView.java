...
public final class CurrencyTextView extends TextView
{
	...
	private CoinFormat format = null;
	...
	public void setFormat(@Nonnull final CoinFormat format)
	{
	...
	{
		final CoinSpannable text;

		if (amount != null)
			text = new CoinSpannable(format, alwaysSigned, amount)
